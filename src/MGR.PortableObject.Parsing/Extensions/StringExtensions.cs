...
internal static class StringExtensions
{
    ...
    private static readonly Dictionary<char, char> EscapeTranslations = new() {
        { 'n', '\n' },
        { 'r', '\r' },
        { 't', '\t' }
    };
    internal static bool StartsWithQuote(this string value) => value.StartsWith(Quote);

    private static bool EndsWithQuote(this string value) => value.EndsWith(Quote);
