...
internal class PortableObjectEntryBuilder
{
    ...
    private readonly PluralFormParser _pluralFormParser = new();
    private readonly CatalogBuilder _catalogBuilder;
    private readonly ParsingContext _parsingContext;
    private readonly List<List<string>> _currentTranslations = [];
    private readonly List<PortableObjectCommentBase> _comments = [];
